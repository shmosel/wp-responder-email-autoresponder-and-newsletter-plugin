              ...
              <div style="font-size: small; padding: 10px; background-color: #eee; width:700px">
                ...
                <table cellspacing="10">
                  ...
                  <tr>
                    ...
                    <td>Your address as you configured it in the <a href="admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/settings.php">Newsletter > Settings</a> page. This is required to be in compliance with
...
<?php echo (!$parameters->confirmed_body)?get_option("wpr_confirmed_body"):$parameters->confirmed_body ?>
    ...
    <tr>
      <td><label for="button"></label>
        ...
        <input class="button" type="button" onclick="window.location='admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/newsletter.php'" name="button" id="button" value="Cancel" /></td>
      <td>&nbsp;</td>
    </tr>
  </table>
</form>
