...

{
...

	{
...

		{
            ...
            <script>window.location='admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/newsletter.php'</script>
...

{
    ...
    <thead>
     ...
     <tr>
       ...
       <input type="button" name="Edit" onclick="window.location='admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/newsletter.php&act=edit&nid=<?php echo $list->id ?>';" value="Edit" class="button" />

       <input type="button" name="Delete" value="Delete" class="button" />

       <input type="button" name="Delete" value="Manage Leads" class="button" onclick="window.location='admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/subscribers.php&action=nmanage&nid=<?php echo $list->id ?>';" />

       <input type="button" name="E-mails" value="Custom Fields" onclick="window.location='admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/newsletter.php&act=custom_field&nid=<?php echo $list->id ?>';" class="button"/>
