...
function _wpr_subscriber_home()
{
	...
	if (count($newsletters))
	{
	 ...
	 <tr> 
		...
		<td><a href="admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/subscribers.php&action=nmanage&nid=<?php echo $newsletter->id ?>" class="button">Manage Subscribers</a>&nbsp;</td>
		</tr>
	  ...
	  if (count($subscribers))
	  {
			foreach ($subscribers as $subscriber)
			{
			  ...
			  <?php if ($allNewslettersMode) 
                   ...
                   <td>
				   <a href="admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/subscribers.php&action=profile&sid=<?php echo $subscriber->id ?>" class="button">Edit</a>&nbsp;
				   </td>
				   </tr>
				   <?php
			}
