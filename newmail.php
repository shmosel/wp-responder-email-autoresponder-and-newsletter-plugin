...
<p>
<a href="admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/allmailouts.php" class="button-primary">View All Broadcasts</a> <a href="admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/wpresponder.php" class="button">Go to Dashboard</a>
</p>
    <?php
