...

{
	...
	$bsubscription = $_POST['blogsubscription'];
...

	{
...

		{
			...
			$query = "UPDATE ".$wpdb->prefix."wpr_subscribers set fid=$fid, name='$name' where email='$email' and nid=$nid";
		...
		{		
			...
			$query = "UPDATE ".$wpdb->prefix."wpr_subscribers set fid=0, name='$name' where email='$email' and nid=$nid";
