...
<?php
    ...
    $formItem = '<div style="float:right; display:block;">Choose Template: <select name="templateChanger" onchange="changeTemplate'.$number.'('.$nameOfCKEditorObject.',\''.$nameOfTextArea.'\',this)">';
