...
The graph cannot be generated because I can't find the newsletter. <a href="admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/wpresponder.php">Click here</a> to go to dashboard. If this keeps happening, please <a href="admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/wpresponder.php">report a bug</a>.</div>
		<?php
		return;
	}
	?>
    <a href="admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/wpresponder.php" style="float:left; margin-top:5px;" class="button">&laquo; Back To Dashboard</a>
