...
function _wpr_manage_responder_delete()
{
	...
	if ($_GET['confirm'] == "true")
	{
		...
		$wpdb->query($query);
		?>
        <script>window.location='admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/autoresponder.php&action=manage&aid=<?php echo $_GET['aid'] ?>';</script>
        <?php
	...
	else
	{
        ...
        <a href="<?php echo $_SERVER['REQUEST_URI'] ?>&confirm=true" class="button">Yes</a>&nbsp; <a href="admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/autoresponder.php&aid=<?php echo $_GET['aid']; ?>&action=manage" class="button">Cancel</a>
        <?php
	}
}
	...
	if (isset($_POST['subject']))
	{
		...
		else
		{
			...
			else
			{
                ...
                <a href="admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/autoresponder.php&action=manage&aid=<?php echo $_GET['aid'] ?>" class="button">OK</a>
                </a>
                <?php
				return;
			}
...
<table class="widefat">
  <tr>
    ...
    <tr>
       ...
       <td><a href="admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/autoresponder.php&action=manage&mact=edit&aid=<?php echo $_GET['aid'] ?>&id=<?php echo $message->id ?>" class="button">Edit</a>&nbsp;<a href="admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/autoresponder.php&action=manage&mact=delete&aid=<?php echo $_GET['aid'] ?>&id=<?php echo $message->id ?>" class="button">Delete</a></td>
    </tr>
       <?php
	}
	?>
</table>
<a href="admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/autoresponder.php" class="button">&laquo; Back To Autoresponders</a>&nbsp;<input type="button" value="Add Message" onclick="window.location='admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/autoresponder.php&action=manage&mact=create&aid=<?php echo $_GET['aid'] ?>'" class="button" />
	...
	if (isset($_POST['subject']))
	{
		...
		else
		{
			...
			else
			{
				...
				?>
<script>
window.location='admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/autoresponder.php&action=manage&aid=<?php echo $_GET['aid']; ?>';
</script>
<?php
				return;
			}
