...
<table class="widefat">
  ...
  <tr>
    ...
    <td><a href="admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/subscriptionforms.php&action=edit&fid=<?php echo $form->id ?>" class="button">Edit</a>&nbsp;<a href="admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/subscriptionforms.php&action=form&fid=<?php echo $form->id ?>" class="button">Get Form HTML</a></td>
  </tr>
  <?php
...
<a href="admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/subscriptionforms.php&action=create" class="button">Create New Form</a>
<?php
...
<a href="admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/subscriptionforms.php" class="button">&laquo; Back To Forms</a>&nbsp;
    ...
    <tr>
      <td colspan="2"><fieldset style="border: 1px solid #888; padding:20px;">
		 ...
		 ?>
            ...
            autoresponder series. <a href="admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/autoresponder.php&action=create" style="float:right">Create Autoresponder</a></label>
          <br />
          <?php 
		 ...
		 ?>
            ...
            post series.</label>
          <a href="admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/blogseries.php&action=create" style="float:right">Create Post Series</a> <br />
...
<?php echo ($parameters->confirmed_body)?$parameters->confirmed_body:get_option("wpr_confirmed_body"); ?>
    ...
    <tr>
      <td colspan="2"><input class="button" type="submit" value="Create Form And Get Code" />
        &nbsp;<a class="button" href="admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/subscriptionforms.php">Cancel</a></td>
    </tr>
  </table>
</form>
<?php
