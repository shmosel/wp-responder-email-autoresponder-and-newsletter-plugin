		...
		if ($name && $type)
		{
			...
			if (!$error)
			{
				$query = "UPDATE `".$wpdb->prefix."wpr_custom_fields` SET `type`='$type',`label`='$label',`enum`='$enum' where id='$cid';" ;
				 $wpdb->query($query);
				?>
<script>window.location='admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/newsletter.php&act=custom_field&nid=<?php echo $nid ?>';</script>
<?php  
				exit;
			}
		}
...
<table class="widefat">
  ...
  <tr>
    ...
    <td><input type="button" value="Edit" onclick="window.location='admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/newsletter.php&act=custom_field&nid=<?php echo $newsletter->id ?>&cfact=edit&cid=<?php echo $field->id ?>'" class="button-primary" />
      <input type="button" value="Delete" onclick="window.location='admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/newsletter.php&act=custom_field&nid=<?php echo $newsletter->id ?>&cfact=delete&cid=<?php echo $field->id ?>';" class="button-primary" /></td>
  </tr>
  <?php
		  }
		  ?>
</table>
<input type="button" value="Add New Field" class="button" onclick="window.location='admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/newsletter.php&act=custom_field&nid=<?php echo $newsletter->id ?>&cfact=create';" /> <input type="button" value="&laquo; Back To Newsletters" style="float:left" onclick="window.location='admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/newsletter.php&act=list';" class="button" />
<?php
}
...
function wpr_customfields()
{
	global $wpdb;
      ...
      foreach ($newsletterList as $newsletter)
      {
 	     ...
 	     <?php echo $newsletter->name ?> </td><td><a class="button" href="admin.phppage=wp-responder-email-autoresponder-and-newsletter-plugin/newsletter.php&act=custom_field&nid=<?php echo $newsletter->id ?>">Manage Custom Fields</a></td></tr>
 	      <?php
      }
      ?></table>
      <?php
